                                    ...
                                    <form action="proses/proses-supplier.php?aksi=updatesupplier" method="POST">
									    <div class="card-body">
											...
											<div class="mb-3">
												...
												<input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Supplier" value="<?php echo $dataSupplier['nama']; ?>" required>
											</div>
											<div class="mb-3">
												<label for="nama" class="form-label">Kontak Supplier</label>
												<input type="text" class="form-control" id="kontak" name="kontak" placeholder="Masukkan Kontak Supplier" value="<?php echo $dataSupplier['kontak']; ?>" required>
											</div>
											<div class="mb-3">
												<label for="nama" class="form-label">Alamat Supplier</label>
												<input type="text" class="form-control" id="alamat" name="kontak" placeholder="Masukkan Alamat Supplier" value="<?php echo $dataSupplier['alamat']; ?>" required>
											</div>
