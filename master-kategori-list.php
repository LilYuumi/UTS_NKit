...
// Menampilkan alert berdasarkan status dari URL
if (isset($_GET['status'])) {
	if ($_GET['status'] == 'inputsuccess') {
		...
		echo "<script>alert('Gagal menghapus kategori. Silakan coba lagi.');</script>";
	}
}

// Ambil data kategori dari class master
						...
						<div class="col-12">
							<div class="card">
								...
								<div class="card-footer">
									<button type="button" class="btn btn-primary" onclick="window.location.href='master-kategori-input.php'">
