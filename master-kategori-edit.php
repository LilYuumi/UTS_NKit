                                    ...
                                    <form action="proses/proses-kategori.php?aksi=updatekategori" method="POST">
									    <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control-plaintext" id="kode" name="kode" placeholder="Masukkan Kode Program Studi" value="<?php echo $dataKategori['id']; ?>" required readonly>
                                            </div>
											<div class="mb-3">
												<label for="nama" class="form-label">Nama Kategori</label>
												<input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Program Studi" value="<?php echo $dataKategori['nama']; ?>" required>
											</div>
                                        </div>
