...
if(isset($_GET['status'])){
    if($_GET['status'] == 'failed'){
        echo "<script>alert('Gagal menambahkan data supplier. Silakan coba lagi.');</script>";
    }
}
?>
<!doctype html>
    ...
    <main class="app-main">
        <div class="app-content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6"><h3 class="mb-0">Input Supplier</h3></div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form action="proses/proses-supplier.php?aksi=inputsupplier" method="POST">
                                <div class="card-body">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="kontak" name="kontak" placeholder="Masukkan Kontak Supplier" required>
                                    </div>
                                    <div class="mb-3">
