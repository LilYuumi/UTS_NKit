			...
			<main class="app-main">
				...
				<div class="app-content-header">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<h3 class="mb-0">Input Supplier</h3>
							</div>
							<div class="col-sm-6">
								...
								<div class="card">
                                    ...
                                    <form action="proses/proses-supplier.php?aksi=inputsupplier" method="POST">
									    ...
									    <div class="card-footer">
                                            <button type="button" class="btn btn-danger me-2 float-start" onclick="window.location.href='master-supplier-list.php'">Batal</button>
